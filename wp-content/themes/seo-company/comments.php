...
<?php if ($comments) : ?>
	<h3 id="comments"><strong><?php comments_number('赶紧抢个沙发做！', '才1个评论', '已经有% 个评论，你也说点什么吧' );?></strong></h3>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<div class="gravatar"><?php if(function_exists("get_avatar")) echo get_avatar( get_comment_author_email(), '48', 'http://qq325.com/uploads/allimg/c110212/12a4OK6335F-491A7.jpg' ); ?>
            ...
            <strong><a href="<?php comment_author_url(); ?>"rel="nofollow"target="_blank"><?php comment_author(); ?></a></strong> 说:
...
<p>您现在是以 <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a> 的身份登录,<a href="<?php echo wp_logout_url(get_permalink()) ?>" title="Log out of this account"> 点击退出系统 &raquo;</a></p>
...
<p id="but_submit"><input name="submit" type="submit" id="submit" tabindex="5" value="提交评论" class="dingping"/>
